...
public class PassengerServices {
	...
	static int fare;
	static List<String> stops = List.of("pune","Mumbai","Goa");
	...
	public static String selectDate() {
		System.out.println("Please enter your date of journey : ");
		String date = sc.next();
		return date;
	}
	...
	public void bookTicket() {
		...
		passengers.add(new Passenger(PassengerServices.selectSeatNo(),PassengerServices.setPnrNo(),PassengerServices.name(),
				PassengerServices.email(),PassengerServices.boardingPoint(),PassengerServices.dropingPoint(),PassengerServices.age(), PassengerServices.selectDate()));
	...
	public static int calculateFare() {
		...
		for(Passenger passenger:passengers) {
			if((passenger.getBoardingPoint().equals("pune")|| passenger.getBoardingPoint().equals("Goa")) 
					&& (passenger.getDropingPoint().equals("Goa") || passenger.getDropingPoint().equals("pune"))) {
			...
			else if ((passenger.getBoardingPoint().equals("pune")||passenger.getBoardingPoint().equals("Mumbai")) 
					&& (passenger.getDropingPoint().equals("Mumbai")|| passenger.getDropingPoint().equals("pune"))) {
				if(passenger.getAge() <= 10 && passenger.getAge() > 0) {
					fare = 600;
				}else if(passenger.getAge() > 70) {
					fare = 700;
			...
			else if ((passenger.getBoardingPoint().equals("Mumbai")|| passenger.getBoardingPoint().equals("Goa")) 
					&& (passenger.getDropingPoint().equals("Goa") || passenger.getDropingPoint().equals("Mumbai"))) {
				if(passenger.getAge() <= 10 && passenger.getAge() > 0) {
					fare = 700;
				}else if(passenger.getAge() > 70) {
					fare = 800;
